...
h2 {
    color: white; /* Set the color of h2 elements to white */
}

form {
    color: white; /* Set the color of form elements to white */
}
...
$sql = "INSERT INTO nymabini_myguests (name, email,website,comment,gender)
